...
public class CadastroProdutoJFrame extends javax.swing.JFrame {
   ...
   //Insataciar o arraylist
    ...
    //caso queira criar variaveis para receber os valore dos campos
        //caso seja interiro converter
        int codigo = Integer.parseInt(tfCodigo.getText());
        String nome = tfNome.getText();
        String descricao = tfDescricao.getText();
        float preco = Float.parseFloat(tfPreco.getText());
        
        //instancaia um novo produto
        Produto novoProduto = new Produto();
        
        
        //set os valores da variaveis no novolivro
        ...
        //adiciona o novo livro no arraylist
        prateleira.add(novoProduto);
        
        
        //apresenta mensagem  para o usuario
        JOptionPane.showMessageDialog(null, "Produto cadastrado");
        
        //limpa os campo de codigo
        tfCodigo.setText("");
        //limpa os campo de nome
        tfNome.setText("");
        //limpa os campo de descricao
        tfDescricao.setText("");
        //limpa os campo de preço
        tfPreco.setText("");
    ...
    private void btVizualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVizualizarActionPerformed
        ...
        //neste caso o visualizar mostra apenas o primeiro produto cadastrado
