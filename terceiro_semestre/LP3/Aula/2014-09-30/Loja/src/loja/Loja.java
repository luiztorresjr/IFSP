...
public class Loja {
    ...
    public static void main(String[] args) {
        ...
        LocalizadorProduto localizar = new LocalizadorProduto();
        ...
        switch(op){
            ...
            case 4:
                break;
            localizar.localizarExibirProdutoCodigo(prateleira);
            localizar.localizarEremoverProdutoCodigo(prateleira);
            case 10:
                String info ="Saindo...";
